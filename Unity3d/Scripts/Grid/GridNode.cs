...
public class GridNode {
    ...
    void createModel() {
        this.model = GameObject.CreatePrimitive(PrimitiveType.Cube);
        this.model.transform.position = Tool.getSceneCoordinates(this.gridCoordinates);
        this.model.GetComponent<MeshRenderer>().enabled = false;
    }
    ...
    public void updateModel() {
        if (this.type == Type.BLANK) {
            ...
            this.model.GetComponent<MeshRenderer>().enabled = true;
            if (this.type == Type.BLOCK) {
                this.model.GetComponent<Renderer>().material.color = Color.gray;
            }
            if (this.type == Type.START) {
                this.model.GetComponent<Renderer>().material.color = Color.green;
            }
            if (this.type == Type.END) {
                this.model.GetComponent<Renderer>().material.color = Color.red;
            }
        }
    }
